...
export class OrdersService {
  ...
  getLocalStorageToken(){
    let userLogined: any = localStorage.getItem("u");
    if (!userLogined) {
  ...
  public getCustomerOrderDetails(id:any):Observable<any>{
    ...
    let url = `${this.BASE_URL}/orders/${id}`;
  ...
  public cancelOrderRequest(id: any,action:any): Observable<any> {
    let token = this.getLocalStorageToken();
    ...
    let url = `${this.BASE_URL}/orders/${action}/${id}`;
